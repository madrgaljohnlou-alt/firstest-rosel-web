...
const ReplacementRequestForm = ({ order, product, onSuccess, onCancel }) => {
    ...
    return (
        <motion.div
            ...
            className="rounded-xl shadow-xl border border-gray-200 p-8"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        onChange={handleInputChange}
                        rows={4}
                        className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 resize-none"
                ...
                <div className="flex gap-4 pt-8 border-t border-gray-200">
                    ...
                    <button
                        ...
                        className="flex-1 px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium shadow-lg hover:shadow-xl disabled:shadow-none"
                    >
                        {isLoading ? (
