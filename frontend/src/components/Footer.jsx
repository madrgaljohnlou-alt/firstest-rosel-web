import { LucideFacebook, LucideInstagram, LucideTwitter, LucidePhone, LucideMail, LucideMapPin } from "lucide-react";
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-24 max-w-7xl">
          <div className="space-y-4 flex flex-col">
            ...
            <div className="flex space-x-4 pt-4">
              <a href="#" className="hover:underline"><LucideFacebook className="w-8 h-8 text-[#82695b]" /></a>
              <a href="#" className="hover:underline"><LucideInstagram className="w-8 h-8 text-[#82695b]" /></a>
              <a href="#" className="hover:underline"><LucideTwitter className="w-8 h-8 text-[#82695b]" /></a>
            </div>
          </div>
          <div className="space-y-4 flex flex-col">
          ...
          <div className="space-y-4 flex flex-col text-[#82695b]">
            ...
            <p><LucidePhone className="inline w-4 h-4 text-[#82695b]" /> 09263203832</p>
            <p><LucideMail className="inline w-4 h-4 text-[#82695b]" /> ipomakanochi27@gmail.com</p>
            <p><LucideMapPin className="inline w-4 h-4 text-[#82695b]" /> Las Pinas, Philippines</p>
          </div>
        </div>
      </section>
