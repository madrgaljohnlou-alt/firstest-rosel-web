        ...
        <div className='p-7 pb-2'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <motion.button
              ...
              className='w-full mt-4 py-2 px-4 bg-[#901414] text-[#feffff] font-bold rounded-lg shadow-lg border border-[#901414] hover:bg-[#8F3333] hover:text-[#feffff] focus:outline-none focus:ring-2 focus:ring-[#901414] focus:ring-offset-2 transition duration-200 disabled:opacity-50'
            >
              {isLoading ? (
