    ...
    return (
        <AdminLayout>
            <div className="h-screen flex flex-col">
                {/* Header */}
                <div className="bg-[#f7e9b8] text-[#030105] px-6 py-4 border-b border-[#f0d896]">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-[#030105]">Chat Management</h1>
                                <p className="text-sm text-[#030105] opacity-70">Customer Support Conversations</p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-2">
                                <div className={`w-2 h-2 rounded-full ${isConnected ? 'bg-green-500' : 'bg-red-500'}`} />
                                <span className="text-sm text-[#030105]">
                ...
                <div className="flex-1 flex overflow-hidden">
                    {/* Chat List Sidebar */}
                    <div className="w-80 bg-[#fffefc] border-r border-[#f7e9b8] flex flex-col">
                        {/* Sidebar Header */}
                        <div className="p-4 border-b border-[#f7e9b8] bg-[#f7e9b8]">
                            <div className="flex items-center justify-between mb-4">
                                <h2 className="text-lg font-semibold text-[#030105]">Chats</h2>
                                <div className="flex items-center space-x-2">
                                    <span className="text-sm text-[#030105] opacity-70">All chats ({filteredChats.length})</span>
                            ...
                            <div className="relative mb-3">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 bg-[#fffefc] border border-[#f7e9b8] rounded-lg 
                                             focus:ring-2 focus:ring-[#860809] focus:border-transparent 
                                             text-[#030105] placeholder-[#030105] opacity-70"
                                />
                            </div>
                            ...
                            {/* Status Filter */}
                                <select
                                    ...
                                    className="w-full px-3 py-2 bg-[#fffefc] border border-[#f7e9b8] rounded-lg 
                                             focus:ring-2 focus:ring-[#860809] focus:border-transparent 
                                             text-[#030105]"
                                >
                        ...
                        <div className="flex-1 overflow-y-auto">
                            {isLoading ? (
                                ...
                                <div className="text-center py-8 px-4">
                                    ...
                                    <p className="text-[#030105] opacity-70">No chats found</p>
                                </div>
                            ) : (
                                <div className="p-2">
                                        ...
                                        <motion.button
                                            ...
                                            className={`w-full p-3 rounded-lg text-left transition-all duration-200 mb-2 ${
                                                selectedChat?._id === chat._id
                                                    ...
                                                    : 'bg-[#f7e9b8] hover:bg-[#f0d896] text-[#030105] border border-transparent hover:border-[#f0d896]'
                                            }`}
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center justify-between mb-1">
                                                        ...
                                                        <span className={`text-xs ${
                                                            selectedChat?._id === chat._id ? 'text-[#fffefc] opacity-70' : 'text-[#030105] opacity-70'
                                                        }`}>
                                                    ...
                                                    <p className={`text-sm truncate mb-2 ${
                                                        selectedChat?._id === chat._id ? 'text-[#fffefc] opacity-80' : 'text-[#030105] opacity-70'
                                                    }`}>
                                                        {chat.customerDetails?.issue || 'No issue description'}
                                                    </p>
                    ...
                    <div className="flex-1 flex flex-col bg-[#fffefc]">
                        {selectedChat ? (
                            <>
                                ...
                                <div className="p-4 border-b border-[#f7e9b8] bg-[#f7e9b8]">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 className="font-semibold text-[#030105]">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            <select
                                                ...
                                                className="px-3 py-2 border border-[#f7e9b8] rounded-lg 
                                                         bg-[#fffefc] text-[#030105] text-sm focus:ring-2 focus:ring-[#860809]"
                                            >
                                                <option value="waiting">Waiting</option>
                                                <option value="active">Active</option>
                                                <option value="resolved">Resolved</option>
                                            ...
                                            <button className="p-2 hover:bg-[#f0d896] rounded-lg transition-colors">
                                ...
                                {/* Message Input */}
                                <div className="p-4 border-t border-[#f7e9b8] bg-[#f7e9b8]">
                                        ...
                                        <form onSubmit={handleSendMessage} className="flex items-end space-x-3">
                                            <div className="flex-1">
                                                <textarea
                                                    ...
                                                    rows={1}
                                                    className="w-full px-4 py-3 border border-[#f7e9b8] rounded-2xl 
                                                             focus:ring-2 focus:ring-[#860809] focus:border-transparent 
                                                             bg-[#fffefc] text-[#030105] resize-none"
                            ...
                            <div className="flex-1 flex items-center justify-center bg-[#fffefc]">
                                <div className="text-center">
                                    ...
                                    <h3 className="text-lg font-semibold text-[#030105] mb-2">
