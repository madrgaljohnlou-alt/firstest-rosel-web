      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-3xl font-bold text-[#860809]">Point of Sale</h1>
            <Link
              to="/pos/history"
              className="flex items-center gap-2 px-4 py-2 bg-[#a31f17] text-white rounded-lg hover:bg-[#860809] transition-colors"
            >
              <History className="w-4 h-4" />
              Transaction History
            </Link>
          </div>
          <p className="text-[#a48674]">Process cash transactions and manage sales</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Search and Filters */}
            <div className="bg-white rounded-lg shadow-sm border border-[#f7e9b8] p-4">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <select
                  ...
                  className="px-4 py-2 border border-[#f7e9b8] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a31f17] focus:border-transparent"
                >
            ...
            {/* Barcode Scanner */}
            <div className="bg-white rounded-lg shadow-sm border border-[#f7e9b8] p-4">
              <h3 className="text-lg font-semibold text-[#860809] mb-4 flex items-center gap-2">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 py-2 px-4 text-sm rounded-lg font-medium transition-colors ${
                      scanMode === 'usb'
                        ? 'bg-[#a31f17] text-white'
                        : 'bg-[#f7e9b8] text-[#860809] hover:bg-[#e6d4a8]'
                    }`}
                  >
                ...
                {/* USB Scanner Info */}
                {scanMode === 'usb' && (
                  <div className="bg-[#f8f3ed] border border-[#f7e9b8] rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-2">
                      <Hash className="w-4 h-4 text-[#860809]" />
                      <span className="text-sm font-medium text-[#860809]">USB Scanner Ready</span>
                    </div>
                    <p className="text-xs text-[#a48674] mb-2">
                      Connect your USB barcode scanner and scan products directly. The scanner will automatically add items to cart.
                    </p>
                    {lastScannedCode && (
                      <div className="text-xs text-[#860809]">
                  ...
                  <div className="bg-[#f8f3ed] border border-[#f7e9b8] rounded-lg p-3">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-[#860809]">Camera Scanner</span>
                      </div>
                      <div className="flex gap-2">
                        <button
                          onClick={startCameraScan}
                          disabled={isScanning}
                          className="px-3 py-1 bg-[#a31f17] text-white text-xs rounded hover:bg-[#860809] disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center gap-1"
                        >
                        ...
                        <button
                          ...
                          disabled={!isScanning}
                          className="px-3 py-1 bg-[#82695b] text-white text-xs rounded hover:bg-[#6b5649] disabled:bg-gray-400 disabled:cursor-not-allowed"
                        >
                          Stop
                        </button>
                      </div>
            ...
            {/* Products Grid */}
            <div className="bg-white rounded-lg shadow-sm border border-[#f7e9b8] p-4">
              <h3 className="text-lg font-semibold text-[#860809] mb-4">Products</h3>
              {productsLoading ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-h-96 overflow-y-auto">
                  {filteredProducts.map(product => (
                    <motion.div
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="border border-[#f7e9b8] rounded-lg p-3 cursor-pointer hover:shadow-md transition-shadow"
                    ...
                    >
                      ...
                      <h4 className="font-medium text-sm text-[#030105] line-clamp-2 mb-1">
                        {product.name}
                      </h4>
                      <p className="text-xs text-[#a48674] capitalize mb-2">
                        {product.category}
                      </p>
                      <div className="flex justify-between items-center">
                        <span className="font-bold text-[#860809]">
                          ₱{product.price.toFixed(2)}
                        </span>
                        <span className="text-xs text-[#a48674]">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-[#f7e9b8] p-4">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-[#860809] flex items-center gap-2">
              ...
              {cart.length === 0 ? (
                <div className="text-center py-8 text-[#a48674]">
                ...
                <div className="space-y-3 max-h-64 overflow-y-auto">
                  {cart.map(item => (
                    <div key={item._id} className="flex items-center gap-3 p-2 border border-[#f7e9b8] rounded-lg">
                      <img
                        src={item.image}
                        alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-medium text-sm text-[#030105] line-clamp-1">
                          {item.name}
                        </h4>
                        <p className="text-xs text-[#a48674]">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-6 h-6 rounded-full bg-[#f7e9b8] flex items-center justify-center hover:bg-[#a31f17] hover:text-white transition-colors"
                        >
                ...
                <div className="grid grid-cols-1 gap-2">
                  <button
                    ...
                    className={`p-3 rounded-lg border-2 transition-colors ${
                      paymentMethod === 'cash'
                        ? 'border-[#a31f17] bg-[#f8f3ed] text-[#860809]'
                        : 'border-[#f7e9b8] hover:border-[#a31f17] text-[#030105]'
                    }`}
                  >
            ...
            <div className="bg-white rounded-lg shadow-sm border border-[#f7e9b8] p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">₱{paymentInfo.subtotal.toFixed(2)}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-green-600">-₱{paymentInfo.discount.toFixed(2)}</span>
                </div>
                <hr className="border-[#f7e9b8]" />
                <div className="flex justify-between text-lg font-bold">
                  <span className="text-[#860809]">Total:</span>
                  <span className="text-[#860809]">₱{paymentInfo.total.toFixed(2)}</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full mt-4 bg-[#a31f17] text-white py-3 px-4 rounded-lg font-semibold hover:bg-[#860809] disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
              >
                <CreditCard className="w-5 h-5" />
                Process Payment
              </button>
