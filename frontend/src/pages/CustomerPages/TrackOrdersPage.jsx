        ...
        <div className="min-h-screen pt-24 pb-8" style={{ backgroundColor: '#fffefc' }}>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                {orderStats && (
                    ...
                    >
                        <div className="rounded-lg shadow-sm border p-6" style={{ backgroundColor: '#f8f3ed' }}>
                    ...
                    {filteredOrders.length === 0 ? (
                        ...
                        filteredOrders.map((order, index) => (
                            <motion.div
                                ...
                                className="rounded-lg shadow-sm border hover:shadow-md transition-shadow cursor-pointer"
                                style={{ backgroundColor: '#f8f3ed' }}
            ...
            >
                <div className="p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-gray-600">{getStatusDescription(order.computedStatus)}</p>
                    </div>
