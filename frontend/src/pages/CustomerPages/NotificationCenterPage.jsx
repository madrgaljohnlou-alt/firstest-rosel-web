        ...
        <>
            <div className="min-h-screen bg-white pt-24 pb-8">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-[#901414]">Notifications</h1>
                            ...
                            <div className="flex items-center space-x-3">
                                {unreadCount > 0 && (
                                    <button
                                        ...
                                        className="flex items-center space-x-2 px-4 py-2 bg-[#901414] text-white rounded-lg hover:bg-[#a31f17] transition-colors"
                                    >
                                        <CheckCheck size={16} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-[#f8f3ed] rounded-lg p-6 shadow-sm">
                ...
                {/* Search and Filters */}
                <div className="bg-[#f8f3ed] rounded-lg shadow-sm p-6 mb-6">
                        ...
                        <form onSubmit={handleSearch} className="flex-1">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#901414] focus:border-transparent"
                                />
                            </div>
                        </form>
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-200">
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#901414] focus:border-transparent"
                                    >
                            ...
                            <div className="mt-4">
                                <button
                                    ...
                                    className="text-sm text-[#901414] hover:text-[#860809]"
                                >
                                    Clear all filters
                                </button>
                            </div>
                ...
                {/* Notifications List */}
                <div className="bg-[#f8f3ed] rounded-lg shadow-sm">
                    {/* Header */}
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <input
                                    ...
                                    className="rounded border-gray-300 text-[#901414] focus:ring-[#901414]"
                                />
                                ...
                                >
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <input
                                            ...
                                            className="mt-1 rounded border-gray-300 text-[#901414] focus:ring-[#901414]"
                                        />
                                                ...
                                                <div className="flex items-center space-x-2 ml-4">
                                                    ...
                                                    {notification.actionUrl && (
                                                        <Link
                                                            ...
                                                            className="p-2 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-[#901414] transition-colors"
                                                            title="View details"
                                                        >
