            ...
            <div className='mx-auto max-w-screen-xl px-4 2xl:px-0'>
                ...
                <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
                    ...
                    >
                        ...
                        <div className='rounded-lg border p-6' style={{ borderColor: '#f7e9b8', backgroundColor: '#f8f3ed' }}>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                ...
                                <div>
                                    ...
                                    <div className='space-y-1'>
                                        <div className='flex items-center gap-2'>
                                            ...
                                            <span className='text-sm' style={{ color: '#030105' }}>{shippingInfo.email}</span>
                                        </div>
                                        <div className='flex items-center gap-2'>
                                            <Phone size={14} style={{ color: '#860809' }} />
                                            <span className='text-sm' style={{ color: '#030105' }}>{shippingInfo.phone}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Shipping Address */}
                                <div>
                                    <h3 className='text-sm font-medium mb-2' style={{ color: '#a31f17' }}>Ship to</h3>
                                    <div className='space-y-1'>
                            ...
                            <div className='space-y-4'>
                                    ...
                                    <div className='flex items-center justify-between'>
                                        <div className='flex items-center gap-3'>
                                            ...
                                            <div className='flex items-center gap-2'>
                                                ...
                                                <div>
                                                    <h3 className='font-medium' style={{ color: '#030105' }}>Pick Up in Store</h3>
                                                    <p className='text-sm' style={{ color: '#a31f17' }}>Free pickup at our location</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='text-right'>
                                            <div className='font-semibold text-green-600'>FREE</div>
                                            <div className='text-xs' style={{ color: '#a31f17' }}>No additional cost</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className='flex items-center justify-between'>
                                        <div className='flex items-center gap-3'>
                                            ...
                                            <div className='flex items-center gap-2'>
                                                ...
                                                <div>
                                                    <h3 className='font-medium' style={{ color: '#030105' }}>Lalamove Delivery</h3>
                                                    <p className='text-sm' style={{ color: '#a31f17' }}>Door-to-door delivery service</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='text-right'>
                                            {isLoadingQuote ? (
                                                <div className='flex items-center gap-2'>
                                                    ...
                                                    <span className='text-sm' style={{ color: '#a31f17' }}>Loading...</span>
                                                </div>
                                            ) : lalamoveQuote ? (
                                                <div>
                                    ...
                                    {selectedShipping === 'lalamove' && lalamoveQuote && (
                                        <div className='mt-4 p-3 rounded-lg' style={{ backgroundColor: '#f8f3ed' }}>
                                            <div className='grid grid-cols-2 gap-4 text-sm'>
                                                <div>
                                                    <span className='font-medium' style={{ color: '#030105' }}>Service Type:</span>
                                                    <span className='ml-2' style={{ color: '#a31f17' }}>{lalamoveQuote.serviceType}</span>
                                                </div>
                                                <div>
                                                    <span className='font-medium' style={{ color: '#030105' }}>Distance:</span>
                                                    <span className='ml-2' style={{ color: '#a31f17' }}>{lalamoveQuote.distance?.toFixed(1) || 0} km</span>
                                                </div>
                                                <div>
                                                    <span className='font-medium' style={{ color: '#030105' }}>Estimated Time:</span>
                                                    <span className='ml-2' style={{ color: '#a31f17' }}>{Math.round(lalamoveQuote.duration || 0)} min</span>
                                                </div>
                                                <div>
                                                    <span className='font-medium' style={{ color: '#030105' }}>Total Weight:</span>
                                                    <span className='ml-2' style={{ color: '#a31f17' }}>{lalamoveQuote.totalWeight || 0} kg</span>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                    ...
                    >
                        ...
                        <div className='rounded-lg border p-6' style={{ borderColor: '#f7e9b8', backgroundColor: '#f8f3ed' }}>
                            <h2 className='text-xl font-semibold mb-4' style={{ color: '#030105' }}>Shipping Details</h2>
                            
                            <div className='space-y-3'>
                                {/* Shipping Method */}
                                <div className='flex justify-between text-sm'>
                                    <span style={{ color: '#030105' }}>Method</span>
                                    ...
                                    {/* Shipping Fee */}
                                <div className='flex justify-between text-sm'>
                                    <span style={{ color: '#030105' }}>Shipping Fee</span>
                                ...
                                {selectedShipping === 'lalamove' && lalamoveQuote && (
                                    <>
                                        <div className='flex justify-between text-sm'>
                                            <span style={{ color: '#030105' }}>Service Type</span>
                                            <span style={{ color: '#860809' }}>{lalamoveQuote.serviceType}</span>
                                        </div>
                                        <div className='flex justify-between text-sm'>
                                            <span style={{ color: '#030105' }}>Distance</span>
                                            <span style={{ color: '#860809' }}>{lalamoveQuote.distance?.toFixed(1) || 0} km</span>
                                        </div>
                                        <div className='flex justify-between text-sm'>
                                            <span style={{ color: '#030105' }}>Est. Time</span>
                                            <span style={{ color: '#860809' }}>{Math.round(lalamoveQuote.duration || 0)} min</span>
                                        </div>
                                    </>
                                )}
                                    ...
                                    <div className='border-t pt-3' style={{ borderColor: '#f7e9b8' }}>
                                        ...
                                        <span style={{ color: '#030105' }}>Final Total</span>
                                            <span style={{ color: '#860809' }}>
                ...
                >
                    <button
                        ...
                        className='flex items-center gap-2 px-8 py-3 rounded-lg text-white font-medium transition-colors hover:opacity-90 focus:outline-none focus:ring-4 disabled:opacity-50'
