...
const InformationPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!selectedLocation) {
            toast.error("Please confirm your location on the map");
            return;
        }
                        ...
                        >
                            ...
                            <div className='rounded-lg border p-6' style={{ borderColor: '#f7e9b8', backgroundColor: '#f8f3ed' }}>
                                ...
                                <div className='space-y-4'>
                                    <div>
                                        <label className='block text-sm font-medium mb-2' style={{ color: '#030105' }}>
                                            Email Address *
                                        </label>
                            ...
                            <div className='rounded-lg border p-6' style={{ borderColor: '#f7e9b8', backgroundColor: '#f8f3ed' }}>
                                ...
                                <div className='mt-6 flex items-center gap-3'>
                                    ...
                                    />
                                    <label htmlFor='saveInfo' className='text-sm font-medium' style={{ color: '#030105' }}>
                                ...
                                <div className='space-y-4'>
                                    ...
                                    <div className='flex gap-3'>
                                        <button
                                            ...
                                            style={{ backgroundColor: '#860809', color: 'white' }}
                                        >
                                            Locate Address
                                        </button>
                                        ...
                                        {selectedLocation && (
                                            <button
                                                ...
                                                className='px-4 py-2 rounded-lg text-sm font-medium transition-colors hover:opacity-90'
                                                style={{ backgroundColor: '#a31f17', color: 'white' }}
                                            >
                                                Confirm Location
                                            </button>
                                        )}
                                    ...
                                    {/* Google Maps */}
                                    <div className='w-full h-64 border rounded-lg overflow-hidden' style={{ borderColor: '#f7e9b8' }}>
                                        {mapError ? (
