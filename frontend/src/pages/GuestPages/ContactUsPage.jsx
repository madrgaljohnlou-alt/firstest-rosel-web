            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              >
                ...
                >
                  ...
                  <p className="text-[#030105] text-lg leading-relaxed mb-8 max-w-lg">
                ...
                >
                  {[
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-[#a31f17] mb-2">{item.title}</h3>
                        <p className={`text-[#030105] ${item.isPreLine ? 'whitespace-pre-line' : ''}`}>
                          {item.content}
                      </p>
                    </div>
                    </motion.div>
              ...
              >
                <motion.h3 
                  className="text-3xl font-bold text-[#860809] mb-6 text-center"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.4 }}
                  viewport={{ once: true }}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
                ...
                >
                  {[
                    ...
                    <motion.div 
                      ...
                      viewport={{ once: true }}
                    >
                      <h3 className="text-xl font-bold text-[#a31f17] mb-3">
                        {faq.question}
                      </h3>
              ...
              >
                <motion.h3 
                  className="text-2xl font-bold text-[#860809] mb-6 flex items-center"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.4 }}
                  viewport={{ once: true }}
                ...
                >
                  <div>
                    <label htmlFor="name" className="block text-sm font-semibold text-[#030105] mb-2">
                      Full Name *
                    </label>
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-semibold text-[#030105] mb-2">
                      Email Address *
                    </label>
                    <div className="relative">
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-sm font-semibold text-[#030105] mb-2">
                      Phone Number
                    </label>
                    <div className="relative">
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-semibold text-[#030105] mb-2">
                      Message *
                    </label>
                    <textarea
                      id="message"
