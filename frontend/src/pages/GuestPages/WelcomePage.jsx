import { LucideAward, LucideShield, LucideTruck, LucideArrowRight, LucideChevronLeft, LucideChevronRight} from "lucide-react";
...
const WelcomePage = () => {
  ...
  return (
    <div className="w-full ">
        ...
        <div className="w-full max-w-8xl px-4 mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 ">
          ...
          >
            <div className="mt-auto">
              <motion.h2 
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-[#ffd901] mb-4"
              ...
              <motion.h1 
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#fffefc] leading-tight mb-6"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <Link to="/login" className="w-full md:w-auto bg-[#ffd901] font-semibold text-[#030105] py-3 px-6 rounded-xl transition-transform hover:scale-105 hover:bg-[#ffe23d] flex items-center justify-center gap-2 shadow-md">
                  Get Started Today <LucideArrowRight className="w-5 h-5" />
                </Link>
                <Link to="/products" className="w-full md:w-auto bg-[#860809] border border-[#860809] font-semibold text-[#fffefc] py-3 px-6 rounded-xl transition-transform hover:scale-105 hover:bg-[#a31f17] flex items-center justify-center shadow-md">
                  Explore Products
                </Link>
              </motion.div>
            </div>
      ...
      >
        <motion.h1 
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-16 sm:mb-7 lg:mb-12 mt-7 max-w-xs sm:max-w-none mx-auto"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-8 max-w-7xl mx-auto px-4">
          {/* Card 1 */}
          <motion.div 
            className="flex flex-col items-center p-6 rounded-lg w-72 sm:w-64 h-96 sm:h-80"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.1 }}
            viewport={{ once: true }}
          >
            <div className="w-36 h-36 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-gray-200 rounded-lg mb-4 flex items-center justify-center">
              <span className="text-gray-500 text-lg sm:text-sm lg:text-base">Image</span>
            </div>
            <h3 className="text-3xl sm:text-xl lg:text-2xl font-bold text-[#901414] mb-3 text-center">Good Pricing</h3>
            <p className="text-xl sm:text-sm lg:text-base text-[#82695b] text-center mb-4">Rosel Frozen Meat offers competitive prices without compromising on quality.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-3xl sm:text-xl lg:text-2xl font-bold text-[#901414] mb-3 text-center">Live Order Tracking</h3>
            <p className="text-xl sm:text-sm lg:text-base text-[#82695b] text-center mb-4">Rosel Frozen Meat offers competitive prices without compromising on quality.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-3xl sm:text-xl lg:text-2xl font-bold text-[#901414] mb-3 text-center">Local Pick-Up</h3>
            <p className="text-xl sm:text-sm lg:text-base text-[#82695b] text-center mb-4">Convenient same-day local pick-up ensures customers get their orders fresh without waiting.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-3xl sm:text-xl lg:text-2xl font-bold text-[#901414] mb-3 text-center">Prestige</h3>
            <p className="text-xl sm:text-sm lg:text-base text-[#82695b] text-center">Trusted by loyal customers, Rosel upholds a reputation for quality and reliability in frozen goods.</p>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <motion.p 
          className="text-lg text-[#901414] font-semibold mt-4 max-w-2xl mx-auto"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          viewport={{ once: true }}
        ...
        <motion.h2 
          className="text-4xl font-bold text-[#030105] mb-4 lg:mb-8"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.4 }}
          viewport={{ once: true }}
            ...
            {premiumProducts.length > 0 ? (
              premiumProducts.map((product, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-[#030105] mb-2 line-clamp-2">{product.name}</h3>
                  <div className="flex justify-center items-center mb-2">
                    <span className="text-xl text-[#901414]">₱{product.price.toFixed(2)}</span>
                  </div>
                  ...
                  <Link
                    ...
                    className="block w-full text-center text-[#901414] py-2 px-4 rounded-lg hover:bg-[#f8f3ed] transition-colors duration-300 font-medium mt-2 opacity-0 group-hover:opacity-100"
                  >
                    View Product
                  </Link>
                </motion.div>
            ...
            {premiumProducts.length > 0 ? (
              <>
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-[#030105] mb-2 line-clamp-2">{premiumProducts[currentProductIndex]?.name}</h3>
                  <div className="flex justify-center items-center mb-2">
                    <span className="text-xl text-[#901414]">₱{premiumProducts[currentProductIndex]?.price.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-center items-center mb-3">
                    <span className={`text-xs font-medium px-2 py-1 rounded-full ${
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Link to="/products" className="mt-8 inline-block bg-[#901414] text-white py-3 px-6 rounded-lg hover:bg-[#a31f17] transition-colors duration-300">
            View All Products
          </Link>
        </motion.div>
      </motion.section>
      ...
      >
        <motion.h2 
          className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#ffd901] max-w-xs sm:max-w-2xl lg:max-w-none mx-auto"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          viewport={{ once: true }}
        ...
        <motion.p 
          className="text-lg sm:text-xl text-[#fffefc] mt-4 max-w-xs sm:max-w-lg lg:max-w-2xl mx-auto"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.4 }}
          viewport={{ once: true }}
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <Link to="/products" className="bg-[#ffd901] font-semibold text-black py-3 px-6 rounded-xl transform transition-transform hover:scale-105 hover:bg-[#ffe23d] flex items-center gap-2">Start Shopping Now <LucideArrowRight className="w-5 h-5" /></Link>
        </motion.div>
      </motion.section>
